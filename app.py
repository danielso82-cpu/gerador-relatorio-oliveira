...
def gerar_html_tabela(df, colunas_legenda):
    """Gera HTML de uma tabela a partir de um DataFrame."""
    html = '<table>\n<thead>\n<tr>\n'
    for col in colunas_legenda:
        html += f'<th>{col}</th>\n'
    html += '</tr>\n</thead>\n<tbody>\n'
...
def montar_html_relatorio(dados):
    """Monta o HTML completo do relatório (usa imagens servidas pelo Flask)."""
...
<body>
  ...
  <div class="header">
    <div class="logo-container">
      <img src="/static/Logo Oliveira Sem Fundo.png" alt="Logo Oliveira" />
    </div>
    <div class="mascote-container">
      <img src="/static/Oliver_RomaneioSF.png" alt="Mascote Romaneio" />
    </div>
  </div>
...
<body>
  <div class="container">
    ...
    <div class="info">
      O relatório será gerado em HTML. Use Ctrl+P no navegador para salvar em PDF.
    </div>
  </div>
</body>
</html>
...
def gerar():
    try:
        ...
        # Agora retornamos o HTML diretamente para o navegador
        return render_template_string(html_rel)
...
if __name__ == "__main__":
    import os
    port = int(os.environ.get("PORT", 5000))  # Porta vinda do Render
